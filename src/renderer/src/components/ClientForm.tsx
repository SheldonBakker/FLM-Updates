...
export default function ClientForm({ client, onClose, onSuccess }: ClientFormProps): JSX.Element {
  ...
  const validateForm = (): boolean => {
    ...
    if (!idRegex.test(formData.id_number)) {
      newErrors.id_number = 'Please enter a valid 13-digit South African ID number'
    }
